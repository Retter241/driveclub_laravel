...
<div id="quest2" class="block">
    <div class="container mb-50 poll-block">
        <div class="row">
            <div class="col-lg-3 width-img">
                <img src="{{ config('app.url')}}/public/site/polling/images/q2.jpg" alt="АКПП">
            </div>
            <div class="col-lg-9 text-left">
...
<div id="quest3" class="block">
    <div class="container mb-50 poll-block">
        <div class="row">
            <div class="col-lg-3 width-img">
                <img src="{{ config('app.url')}}/public/site/polling/images/q3.jpg" alt="АКПП">
            </div>
            <div class="col-lg-9 text-left">
                ...
                <label><input name="q3" type="radio" value="b">передачи крутящего момента от маховика коленчатого вала двигателя к первичному валу коробки передач (верно)</label>
                <label><input name="q3" type="radio" value="c">обеспечения лучшего сцепления автомобиля сдорогой</label>
...
<div id="quest4" class="block">
    <div class="container mb-50 poll-block">
        <div class="row">
            <div class="col-lg-3 width-img">
                <img src="{{ config('app.url')}}/public/site/polling/images/q4.jpg" alt="АКПП">
            </div>
            <div class="col-lg-9 text-left">
...
<div id="quest5" class="block">
    <div class="container mb-50 poll-block">
        <div class="row">
            <div class="col-lg-3 width-img">
                <img src="{{ config('app.url')}}/public/site/polling/images/q5.jpg" alt="АКПП">
            </div>
            <div class="col-lg-9 text-left">
...
<div id="quest6" class="block">
    <div class="container mb-50 poll-block">
        <div class="row">
            <div class="col-lg-3 width-img">
                <img src="{{ config('app.url')}}/public/site/polling/images/q6.jpg" alt="АКПП">
            </div>
            <div class="col-lg-9 text-left">
...
<div id="quest7" class="block">
    <div class="container mb-50 poll-block">
        <div class="row">
            <div class="col-lg-3 width-img">
                <img src="{{ config('app.url')}}/public/site/polling/images/q7.jpg" alt="АКПП">
            </div>
            <div class="col-lg-9 text-left">
                <p>Масляный насос является элементом</p>
                <label><input name="q7" type="radio" value="a" checked>Системы смазки
                    (верно)</label>
...
<div id="quest8" class="block">
    <div class="container mb-50 poll-block">
        <div class="row">
            <div class="col-lg-3 width-img">
                <img src="{{ config('app.url')}}/public/site/polling/images/q8.jpg" alt="АКПП">
            </div>
            <div class="col-lg-9 text-left">
                ...
                <label><input name="q8" type="radio" value="c">распределительный вал
                    (верно)</label>
...
<div id="quest9" class="block">
    <div class="container mb-50 poll-block">
        <div class="row">
            <div class="col-lg-3 width-img">
                <img src="{{ config('app.url')}}/public/site/polling/images/q9.jpg" alt="АКПП">
            </div>
            <div class="col-lg-9 text-left">
                ...
                <label><input name="q9" type="radio" value="c">звуковые волны
                    (верно)</label>
                <label><input name="sub9" class="btn btn9" data-num="10" type="button" value="Далее"></label>
            </div>
        </div>
    </div>
</div>
...
<div id="quest10" class="block">
    <div class="container mb-50 poll-block">
        <div class="row">
            <div class="col-lg-3 width-img">
                <img src="{{ config('app.url')}}/public/site/polling/images/q10.jpg" alt="АКПП">
            </div>
            <div class="col-lg-9 text-left">
                ...
                <label><input name="q10" type="radio" value="c">Датчик курсовой
                    устойчивости</label>
                <label>{!! Form::submit('Узнать результат' ,['class'=>'btn'])
                    !!}</label>
            </div>
        </div>
    </div>
